...
class Roleplay:
    ...
    async def _hack(self, ctx, difficulty: int, who=None, channel: discord.TextChannel=None):
        ...
        embed = discord.Embed(title="**::Hacking sequence initiated for Security Level {}::**".format(abs(difficulty)),
                              description=("```:rp_utility1: Encryption Cracking Unit paired with device.\n"
                                           ":rp_utility1: Emulation Program Functional.\n"
                                           ":rp_utility1: Data Package Compilation Program Functional.\n"
                                           ":rp_utility1: Virus Defense Program Functional.```"),
        ...
        for i in range(abs(difficulty)):
            ...
            if prob > limit:
                ...
                embed.add_field(name="**::Hacking sequence failed::**",
                                value=("```:rp_utility0: Encryption Cracking Unit disconnected from device.\n"
        ...
        embed.add_field(name="**::Hacking sequence was completed successfully::**",
                        value=("```:rp_utility1: Encryption Cracking Unit paired with device.\n"
